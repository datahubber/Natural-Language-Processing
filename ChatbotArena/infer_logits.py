...
if IS_SUBMISSION:
    ...
    ds = Dataset.from_parquet("data/full_swap_hf-open.parquet")
    folds = [
    (
...
model_path ="merge_model/qwen_14b_wsdm+lmsys+add_swap"# "merge_model/merge_qwen"#model/qwen-14b "awq_models/awq_qwen"#
...
df.to_parquet('data/final_data_logits.parquet')
df.to_csv('data/final_data_logits.csv')
